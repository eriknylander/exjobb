...
shellcode:
    lea esi, [shellstring]        ; Store the address of "/bin/sh" in ESI
    xor        eax, eax           ; Zero out EAX
    						     ; Write the null byte at the end of the string
    ...
    mov        eax,  0xb           ; Store the number of the syscall (11) in EAX
