...
\begin{verbatim}
    ...
    nop word ptr [ecc - 0x6f6f6f28]    ; 66 0f 1f 84 21 d8 90 90 90
\end{verbatim}
...
The problems with this way of doing it are those that arise when using instruction overlapping in itself, namely to make the HEP and MEP runnable as well as obfuscating a whole program  without having the MEP synchronize with the HEP.
